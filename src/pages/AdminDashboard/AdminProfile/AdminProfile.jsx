        ...
        <div className="h-[80vh] flex flex-col items-center justify-center gap-5 overflow-hidden">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                <input
                    ...
                    className={`px-4 py-2 border ${errors.oldPassword ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
                ...
                <input
                    ...
                    className={`px-4 py-2 border ${errors.newPassword ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
                ...
                <input
                    ...
                    className={`px-4 py-2 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-md`}
                />
